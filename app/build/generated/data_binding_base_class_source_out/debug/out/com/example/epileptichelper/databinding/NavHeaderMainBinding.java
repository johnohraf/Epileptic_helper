...
public final class NavHeaderMainBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout LinearLayoutIdHeder;

  @NonNull
  public final TextView textView;

  private NavHeaderMainBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout LinearLayoutIdHeder, @NonNull TextView textView) {
    this.rootView = rootView;
    this.LinearLayoutIdHeder = LinearLayoutIdHeder;
  ...
  public static NavHeaderMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      LinearLayout LinearLayoutIdHeder = (LinearLayout) rootView;
      ...
      return new NavHeaderMainBinding((LinearLayout) rootView, LinearLayoutIdHeder, textView);
    }
